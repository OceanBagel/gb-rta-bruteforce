...
public interface Libgambatte extends Library {
	...
	public static final Libgambatte INSTANCE = (Libgambatte)Native.loadLibrary("libgambatte/libgambatte.so", Libgambatte.class);
	...
	void gambatte_setinputgetter(Pointer gb, IJoypadCallback getInput, Pointer p);
}